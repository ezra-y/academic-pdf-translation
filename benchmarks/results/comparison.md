...
| 项目 | 基线 | 修改后 |
| --- | --- | --- |
| git 提交 | `025b7a3434` | `a9af520927` |
| renderer_build_id | `2eb01fb6e630ce3b96187bb3e832d6c1443a16ae837ace5f983b8623d86c3a8f` | `d68769d8e8d0eaa734b7d2fd92ec49385d8ad7d2ef6b056449e554cf465d59c3` |
| 每种状态重复次数 | 5 | 3 |
| 运行时 1 分钟负载 | 6.72 | 6.32 |
| CPU 核数 | 15 | 15 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| single-column-body | 1.551 | 1.562 | +0.8% | 1.440 | 1.545 | +7.3% |
| two-column-body | 1.565 | 1.783 | +14.0% | 1.631 | 1.840 | +12.8% |
| structured-table-and-model | 0.413 | 0.660 | +59.5% | 0.405 | 0.617 | +52.3% |
| image-heavy | 0.285 | 0.546 | +91.5% | 0.250 | 0.493 | +97.0% |
| reference-heavy | 1.418 | 1.579 | +11.4% | 1.548 | 1.544 | -0.2% |
| **合计** | **5.232** | **6.131** | **+17.2%** | **5.274** | **6.038** | **+14.5%** |

### 单次运行内部的抖动

| 案例 | 基线冷启动极差 | 修改后冷启动极差 |
| --- | ---: | ---: |
| single-column-body | 17% | 12% |
| two-column-body | 4% | 6% |
