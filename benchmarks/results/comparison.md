...
| 项目 | 基线 | 修改后 |
| --- | --- | --- |
| git 提交 | `025b7a3434` | `2ad586f4a0` |
| renderer_build_id | `2eb01fb6e630ce3b96187bb3e832d6c1443a16ae837ace5f983b8623d86c3a8f` | `7747c32bbb2942e455f89dee864718761d645e790de044be677e0e6df430e914` |
| 每种状态重复次数 | 5 | 5 |
| 运行时 1 分钟负载 | 6.72 | 7.05 |
| CPU 核数 | 15 | 15 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| single-column-body | 1.551 | 1.592 | +2.6% | 1.440 | 1.568 | +8.8% |
| two-column-body | 1.565 | 1.746 | +11.6% | 1.631 | 1.757 | +7.7% |
| structured-table-and-model | 0.413 | 0.610 | +47.5% | 0.405 | 0.601 | +48.3% |
| image-heavy | 0.285 | 0.538 | +88.5% | 0.250 | 0.503 | +100.8% |
| reference-heavy | 1.418 | 1.438 | +1.4% | 1.548 | 1.426 | -7.8% |
| **合计** | **5.232** | **5.923** | **+13.2%** | **5.274** | **5.854** | **+11.0%** |
...
| two-column-body | 4% | 4% |
| structured-table-and-model | 24% | 3% |
| image-heavy | 15% | 6% |
| reference-heavy | 4% | 2% |
