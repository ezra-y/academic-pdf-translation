...
| 项目 | 基线 | 修改后 |
| --- | --- | --- |
| git 提交 | `025b7a3434` | `28840d9856` |
| renderer_build_id | `2eb01fb6e630ce3b96187bb3e832d6c1443a16ae837ace5f983b8623d86c3a8f` | `32b497ce35988545b8b677dfc7c0517830fb2e6dc487e09383b09f4fa176283a` |
| 每种状态重复次数 | 5 | 3 |
| 运行时 1 分钟负载 | 6.72 | 4.84 |
| CPU 核数 | 15 | 15 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| single-column-body | 1.551 | 1.861 | +20.0% | 1.440 | 1.750 | +21.5% |
| two-column-body | 1.565 | 1.879 | +20.1% | 1.631 | 1.876 | +15.0% |
| structured-table-and-model | 0.413 | 0.618 | +49.4% | 0.405 | 0.605 | +49.4% |
| image-heavy | 0.285 | 0.513 | +79.8% | 0.250 | 0.492 | +96.7% |
| reference-heavy | 1.418 | 1.497 | +5.6% | 1.548 | 1.492 | -3.6% |
| **合计** | **5.232** | **6.369** | **+21.7%** | **5.274** | **6.216** | **+17.8%** |

### 单次运行内部的抖动

| 案例 | 基线冷启动极差 | 修改后冷启动极差 |
| --- | ---: | ---: |
| single-column-body | 17% | 10% |
| two-column-body | 4% | 2% |
