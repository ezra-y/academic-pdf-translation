...
| 项目 | 基线 | 修改后 |
| --- | --- | --- |
| git 提交 | `025b7a3434` | `7962d87049` |
| renderer_build_id | `2eb01fb6e630ce3b96187bb3e832d6c1443a16ae837ace5f983b8623d86c3a8f` | `75c5ce45dcbeb9660d9ff1e477d65d9a134784bc17b0604005e62bdf2257513c` |
| 每种状态重复次数 | 5 | 5 |
| 运行时 1 分钟负载 | 6.72 | 5.44 |
| CPU 核数 | 15 | 15 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| single-column-body | 1.551 | 1.600 | +3.2% | 1.440 | 1.720 | +19.4% |
| two-column-body | 1.565 | 1.968 | +25.8% | 1.631 | 2.085 | +27.8% |
| structured-table-and-model | 0.413 | 0.645 | +56.1% | 0.405 | 0.629 | +55.3% |
| image-heavy | 0.285 | 0.553 | +93.8% | 0.250 | 0.524 | +109.4% |
| reference-heavy | 1.418 | 1.766 | +24.5% | 1.548 | 1.596 | +3.1% |
| **合计** | **5.232** | **6.533** | **+24.8%** | **5.274** | **6.553** | **+24.3%** |

### 单次运行内部的抖动

| 案例 | 基线冷启动极差 | 修改后冷启动极差 |
| --- | ---: | ---: |
| single-column-body | 17% | 6% |
| two-column-body | 4% | 9% |
| structured-table-and-model | 24% | 22% |
| image-heavy | 15% | 3% |
| reference-heavy | 4% | 21% |
