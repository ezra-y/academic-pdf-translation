...
| 项目 | 基线 | 修改后 |
| --- | --- | --- |
| git 提交 | `025b7a3434` | `b8572d96be` |
| renderer_build_id | `2eb01fb6e630ce3b96187bb3e832d6c1443a16ae837ace5f983b8623d86c3a8f` | `8688c8addf6c2383fd8259be344ad1e7abc4f69069c33a4cadc7ed39e99df907` |
| 每种状态重复次数 | 5 | 3 |
| 运行时 1 分钟负载 | 6.72 | 8.91 |
| CPU 核数 | 15 | 15 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| single-column-body | 1.551 | 1.736 | +11.9% | 1.440 | 1.748 | +21.3% |
| two-column-body | 1.565 | 1.798 | +14.9% | 1.631 | 2.118 | +29.8% |
| structured-table-and-model | 0.413 | 0.708 | +71.2% | 0.405 | 0.706 | +74.3% |
| image-heavy | 0.285 | 0.561 | +96.5% | 0.250 | 0.586 | +134.0% |
| reference-heavy | 1.418 | 1.665 | +17.4% | 1.548 | 1.471 | -4.9% |
| **合计** | **5.232** | **6.467** | **+23.6%** | **5.274** | **6.628** | **+25.7%** |
...
| two-column-body | 4% | 3% |
| structured-table-and-model | 24% | 8% |
| image-heavy | 15% | 5% |
| reference-heavy | 4% | 15% |
