...
| 项目 | 基线 | 修改后 |
| --- | --- | --- |
| git 提交 | `025b7a3434` | `04f2e1cb07` |
| renderer_build_id | `2eb01fb6e630ce3b96187bb3e832d6c1443a16ae837ace5f983b8623d86c3a8f` | `7edb10a7aea30d740c3f50e1b81913cd499afabfc179331691bca09703dc68bb` |
| 每种状态重复次数 | 5 | 3 |
| 运行时 1 分钟负载 | 6.72 | 7.91 |
| CPU 核数 | 15 | 15 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| single-column-body | 1.551 | 2.437 | +57.1% | 1.440 | 2.814 | +95.3% |
| two-column-body | 1.565 | 2.319 | +48.2% | 1.631 | 2.333 | +43.0% |
| structured-table-and-model | 0.413 | 0.954 | +130.7% | 0.405 | 0.943 | +132.9% |
| image-heavy | 0.285 | 0.613 | +114.7% | 0.250 | 0.608 | +142.9% |
| reference-heavy | 1.418 | 2.071 | +46.0% | 1.548 | 1.912 | +23.6% |
| **合计** | **5.232** | **8.393** | **+60.4%** | **5.274** | **8.611** | **+63.3%** |

### 单次运行内部的抖动

| 案例 | 基线冷启动极差 | 修改后冷启动极差 |
| --- | ---: | ---: |
| single-column-body | 17% | 30% |
| two-column-body | 4% | 4% |
| structured-table-and-model | 24% | 9% |
| image-heavy | 15% | 7% |
| reference-heavy | 4% | 7% |
