...
| 项目 | 基线 | 修改后 |
| --- | --- | --- |
| git 提交 | `025b7a3434` | `c4203cf9ad` |
| renderer_build_id | `2eb01fb6e630ce3b96187bb3e832d6c1443a16ae837ace5f983b8623d86c3a8f` | `79cf02951bec19655a31b821d90b61c6fcb293886cebb2efc47ab09ab5d9f77c` |
| 每种状态重复次数 | 5 | 3 |
| 运行时 1 分钟负载 | 6.72 | 4.39 |
| CPU 核数 | 15 | 15 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| single-column-body | 1.551 | 1.601 | +3.2% | 1.440 | 1.580 | +9.7% |
| two-column-body | 1.565 | 1.697 | +8.5% | 1.631 | 1.702 | +4.3% |
| structured-table-and-model | 0.413 | 0.613 | +48.1% | 0.405 | 0.583 | +43.9% |
| image-heavy | 0.285 | 0.508 | +78.0% | 0.250 | 0.497 | +98.4% |
| reference-heavy | 1.418 | 1.427 | +0.6% | 1.548 | 1.451 | -6.2% |
| **合计** | **5.232** | **5.846** | **+11.7%** | **5.274** | **5.813** | **+10.2%** |

### 单次运行内部的抖动

| 案例 | 基线冷启动极差 | 修改后冷启动极差 |
| --- | ---: | ---: |
| single-column-body | 17% | 4% |
| two-column-body | 4% | 1% |
