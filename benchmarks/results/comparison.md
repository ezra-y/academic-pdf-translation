...
| 项目 | 基线 | 修改后 |
| --- | --- | --- |
| git 提交 | `025b7a3434` | `b674d9fe89` |
| renderer_build_id | `2eb01fb6e630ce3b96187bb3e832d6c1443a16ae837ace5f983b8623d86c3a8f` | `1bd7a17bc00556268f21a9de14b4a118d806a8daecbd594ceb234f889825bc1f` |
| 每种状态重复次数 | 5 | 3 |
| 运行时 1 分钟负载 | 6.72 | 8.92 |
| CPU 核数 | 15 | 15 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| single-column-body | 1.551 | 1.817 | +17.2% | 1.440 | 1.720 | +19.4% |
| two-column-body | 1.565 | 2.222 | +42.0% | 1.631 | 2.337 | +43.3% |
| structured-table-and-model | 0.413 | 0.877 | +112.1% | 0.405 | 0.729 | +80.1% |
| image-heavy | 0.285 | 0.638 | +123.7% | 0.250 | 0.594 | +137.4% |
| reference-heavy | 1.418 | 1.794 | +26.5% | 1.548 | 1.846 | +19.3% |
| **合计** | **5.232** | **7.349** | **+40.5%** | **5.274** | **7.227** | **+37.0%** |

### 单次运行内部的抖动

| 案例 | 基线冷启动极差 | 修改后冷启动极差 |
| --- | ---: | ---: |
| single-column-body | 17% | 3% |
| two-column-body | 4% | 8% |
| structured-table-and-model | 24% | 26% |
| image-heavy | 15% | 11% |
| reference-heavy | 4% | 2% |
