...
| 项目 | 基线 | 修改后 |
| --- | --- | --- |
| git 提交 | `025b7a3434` | `f62655555b` |
| renderer_build_id | `2eb01fb6e630ce3b96187bb3e832d6c1443a16ae837ace5f983b8623d86c3a8f` | `f9d9dbc7b3b01f2d303f47d47ed8986c3ea9dce2ed382a56e754c2c737504719` |
| 每种状态重复次数 | 5 | 3 |
| 运行时 1 分钟负载 | 6.72 | 5.89 |
| CPU 核数 | 15 | 15 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| single-column-body | 1.551 | 1.587 | +2.4% | 1.440 | 1.605 | +11.4% |
| two-column-body | 1.565 | 1.775 | +13.4% | 1.631 | 1.794 | +10.0% |
| structured-table-and-model | 0.413 | 0.634 | +53.4% | 0.405 | 0.596 | +47.1% |
| image-heavy | 0.285 | 0.546 | +91.4% | 0.250 | 0.513 | +105.0% |
| reference-heavy | 1.418 | 1.532 | +8.1% | 1.548 | 1.456 | -5.9% |
| **合计** | **5.232** | **6.075** | **+16.1%** | **5.274** | **5.963** | **+13.1%** |

### 单次运行内部的抖动

| 案例 | 基线冷启动极差 | 修改后冷启动极差 |
| --- | ---: | ---: |
| single-column-body | 17% | 7% |
| two-column-body | 4% | 4% |
