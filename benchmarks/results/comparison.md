...
| 项目 | 基线 | 修改后 |
| --- | --- | --- |
| git 提交 | `025b7a3434` | `ec31bfe9f8` |
| renderer_build_id | `2eb01fb6e630ce3b96187bb3e832d6c1443a16ae837ace5f983b8623d86c3a8f` | `82d3fc0ddc81c1569267adabdeebf80a80d87f13185e1b4ad34131c5e904420b` |
| 每种状态重复次数 | 5 | 5 |
| 运行时 1 分钟负载 | 6.72 | 6.36 |
| CPU 核数 | 15 | 15 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| single-column-body | 1.551 | 1.754 | +13.1% | 1.440 | 1.684 | +16.9% |
| two-column-body | 1.565 | 1.834 | +17.2% | 1.631 | 1.929 | +18.2% |
| structured-table-and-model | 0.413 | 0.735 | +77.6% | 0.405 | 0.719 | +77.6% |
| image-heavy | 0.285 | 0.585 | +104.9% | 0.250 | 0.568 | +127.0% |
| reference-heavy | 1.418 | 1.663 | +17.3% | 1.548 | 1.587 | +2.5% |
| **合计** | **5.232** | **6.570** | **+25.6%** | **5.274** | **6.487** | **+23.0%** |

### 单次运行内部的抖动

| 案例 | 基线冷启动极差 | 修改后冷启动极差 |
| --- | ---: | ---: |
| single-column-body | 17% | 14% |
| two-column-body | 4% | 2% |
| structured-table-and-model | 24% | 10% |
| image-heavy | 15% | 6% |
| reference-heavy | 4% | 7% |
