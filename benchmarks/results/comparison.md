...
| 项目 | 基线 | 修改后 |
| --- | --- | --- |
| git 提交 | `025b7a3434` | `799118c042` |
| renderer_build_id | `2eb01fb6e630ce3b96187bb3e832d6c1443a16ae837ace5f983b8623d86c3a8f` | `f9daf26b9464cc17723b01d7a1850cd22936ad0f525d3a31d79d7ffb10a9c643` |
| 每种状态重复次数 | 5 | 3 |
| 运行时 1 分钟负载 | 6.72 | 10.69 |
| CPU 核数 | 15 | 15 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| single-column-body | 1.551 | 3.124 | +101.5% | 1.440 | 2.409 | +67.3% |
| two-column-body | 1.565 | 3.057 | +95.4% | 1.631 | 2.417 | +48.1% |
| structured-table-and-model | 0.413 | 0.783 | +89.4% | 0.405 | 0.733 | +81.1% |
| image-heavy | 0.285 | 0.625 | +118.9% | 0.250 | 0.599 | +139.5% |
| reference-heavy | 1.418 | 1.792 | +26.4% | 1.548 | 1.775 | +14.7% |
| **合计** | **5.232** | **9.381** | **+79.3%** | **5.274** | **7.934** | **+50.4%** |

### 单次运行内部的抖动

| 案例 | 基线冷启动极差 | 修改后冷启动极差 |
| --- | ---: | ---: |
| single-column-body | 17% | 17% |
| two-column-body | 4% | 31% |
| structured-table-and-model | 24% | 7% |
| image-heavy | 15% | 3% |
| reference-heavy | 4% | 4% |
