...
| 项目 | 基线 | 修改后 |
| --- | --- | --- |
| git 提交 | `025b7a3434` | `583dc352b3` |
| renderer_build_id | `2eb01fb6e630ce3b96187bb3e832d6c1443a16ae837ace5f983b8623d86c3a8f` | `67690043b207e50d3d18cac58058b18b733fecbdf6d293673ef59eb27aad94b7` |
| 每种状态重复次数 | 5 | 3 |
| 运行时 1 分钟负载 | 6.72 | 5.79 |
| CPU 核数 | 15 | 15 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| single-column-body | 1.551 | 1.596 | +2.9% | 1.440 | 1.576 | +9.4% |
| two-column-body | 1.565 | 1.809 | +15.6% | 1.631 | 1.800 | +10.3% |
| structured-table-and-model | 0.413 | 0.590 | +42.7% | 0.405 | 0.584 | +44.2% |
| image-heavy | 0.285 | 0.518 | +81.6% | 0.250 | 0.491 | +96.0% |
| reference-heavy | 1.418 | 1.475 | +4.0% | 1.548 | 1.424 | -8.0% |
| **合计** | **5.232** | **5.989** | **+14.5%** | **5.274** | **5.874** | **+11.4%** |

### 单次运行内部的抖动

| 案例 | 基线冷启动极差 | 修改后冷启动极差 |
| --- | ---: | ---: |
| single-column-body | 17% | 2% |
| two-column-body | 4% | 7% |
| structured-table-and-model | 24% | 1% |
| image-heavy | 15% | 4% |
| reference-heavy | 4% | 7% |
