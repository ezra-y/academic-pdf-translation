...
| 项目 | 基线 | 修改后 |
| --- | --- | --- |
| git 提交 | `025b7a3434` | `482b0de53b` |
| renderer_build_id | `2eb01fb6e630ce3b96187bb3e832d6c1443a16ae837ace5f983b8623d86c3a8f` | `40f745e1f84c298b95cb27120697ac8a21a9110245dd533b375356c203fb1e04` |
| 每种状态重复次数 | 5 | 5 |
| 运行时 1 分钟负载 | 6.72 | 6.69 |
| CPU 核数 | 15 | 15 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| single-column-body | 1.551 | 1.584 | +2.1% | 1.440 | 1.723 | +19.7% |
| two-column-body | 1.565 | 1.677 | +7.2% | 1.631 | 1.681 | +3.1% |
| structured-table-and-model | 0.413 | 0.452 | +9.3% | 0.405 | 0.439 | +8.5% |
| image-heavy | 0.285 | 0.347 | +21.6% | 0.250 | 0.326 | +30.1% |
| reference-heavy | 1.418 | 1.431 | +0.9% | 1.548 | 1.412 | -8.8% |
| **合计** | **5.232** | **5.491** | **+4.9%** | **5.274** | **5.581** | **+5.8%** |
