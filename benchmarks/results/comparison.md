...
| 项目 | 基线 | 修改后 |
| --- | --- | --- |
| git 提交 | `025b7a3434` | `e4b0321090` |
| renderer_build_id | `2eb01fb6e630ce3b96187bb3e832d6c1443a16ae837ace5f983b8623d86c3a8f` | `7f0b0431c352483b2162a0ca15cac5a2b7093a0a280a90113d8eab01730390b0` |
| 每种状态重复次数 | 5 | 3 |
| 运行时 1 分钟负载 | 6.72 | 7.88 |
| CPU 核数 | 15 | 15 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| single-column-body | 1.551 | 1.529 | -1.4% | 1.440 | 1.481 | +2.8% |
| two-column-body | 1.565 | 1.782 | +13.9% | 1.631 | 1.756 | +7.6% |
| structured-table-and-model | 0.413 | 0.576 | +39.3% | 0.405 | 0.560 | +38.4% |
| image-heavy | 0.285 | 0.479 | +67.9% | 0.250 | 0.454 | +81.2% |
| reference-heavy | 1.418 | 1.385 | -2.4% | 1.548 | 1.375 | -11.1% |
| **合计** | **5.232** | **5.750** | **+9.9%** | **5.274** | **5.626** | **+6.7%** |

### 单次运行内部的抖动

| 案例 | 基线冷启动极差 | 修改后冷启动极差 |
| --- | ---: | ---: |
| single-column-body | 17% | 13% |
| two-column-body | 4% | 1% |
