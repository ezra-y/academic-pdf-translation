...
| 项目 | 基线 | 修改后 |
| --- | --- | --- |
| git 提交 | `025b7a3434` | `ac29e6acd4` |
| renderer_build_id | `2eb01fb6e630ce3b96187bb3e832d6c1443a16ae837ace5f983b8623d86c3a8f` | `6a255b0dfd371fefbfe42b7ce3151cecadf2d5906e99adac95c566f58bd1ed51` |
| 每种状态重复次数 | 5 | 3 |
| 运行时 1 分钟负载 | 6.72 | 5.46 |
| CPU 核数 | 15 | 15 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| single-column-body | 1.551 | 1.460 | -5.9% | 1.440 | 1.452 | +0.8% |
| two-column-body | 1.565 | 1.720 | +9.9% | 1.631 | 1.702 | +4.3% |
| structured-table-and-model | 0.413 | 0.557 | +34.6% | 0.405 | 0.548 | +35.2% |
| image-heavy | 0.285 | 0.471 | +65.0% | 0.250 | 0.457 | +82.6% |
| reference-heavy | 1.418 | 1.339 | -5.6% | 1.548 | 1.323 | -14.5% |
| **合计** | **5.232** | **5.546** | **+6.0%** | **5.274** | **5.482** | **+3.9%** |
