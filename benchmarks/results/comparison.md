...
| 项目 | 基线 | 修改后 |
| --- | --- | --- |
| git 提交 | `025b7a3434` | `1624547d7b` |
| renderer_build_id | `2eb01fb6e630ce3b96187bb3e832d6c1443a16ae837ace5f983b8623d86c3a8f` | `4efcfe900bdfa34c1660c3c5e5878a9854fa99056c34b0c7b14ff0b7d59462d3` |
| 每种状态重复次数 | 5 | 3 |
| 运行时 1 分钟负载 | 6.72 | 10.49 |
| CPU 核数 | 15 | 15 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| single-column-body | 1.551 | 2.227 | +43.6% | 1.440 | 2.010 | +39.5% |
| two-column-body | 1.565 | 2.404 | +53.6% | 1.631 | 2.315 | +41.9% |
| structured-table-and-model | 0.413 | 0.861 | +108.1% | 0.405 | 0.737 | +81.9% |
| image-heavy | 0.285 | 0.600 | +110.1% | 0.250 | 0.600 | +139.5% |
| reference-heavy | 1.418 | 1.847 | +30.2% | 1.548 | 1.682 | +8.7% |
| **合计** | **5.232** | **7.938** | **+51.7%** | **5.274** | **7.343** | **+39.2%** |

### 单次运行内部的抖动

| 案例 | 基线冷启动极差 | 修改后冷启动极差 |
| --- | ---: | ---: |
| single-column-body | 17% | 15% |
| two-column-body | 4% | 35% |
| structured-table-and-model | 24% | 6% |
| image-heavy | 15% | 4% |
| reference-heavy | 4% | 3% |
