...
| 项目 | 基线 | 修改后 |
| --- | --- | --- |
| git 提交 | `025b7a3434` | `fde86cef7d` |
| renderer_build_id | `2eb01fb6e630ce3b96187bb3e832d6c1443a16ae837ace5f983b8623d86c3a8f` | `cadaca94ae81188636defcc9ee91f8232176bed36fb94138570d35ddd33a7716` |
| 每种状态重复次数 | 5 | 3 |
| 运行时 1 分钟负载 | 6.72 | 7.1 |
| CPU 核数 | 15 | 15 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| single-column-body | 1.551 | 1.960 | +26.4% | 1.440 | 1.865 | +29.5% |
| two-column-body | 1.565 | 2.231 | +42.6% | 1.631 | 2.272 | +39.3% |
| structured-table-and-model | 0.413 | 0.835 | +102.0% | 0.405 | 0.752 | +85.8% |
| image-heavy | 0.285 | 0.608 | +113.2% | 0.250 | 0.614 | +145.2% |
| reference-heavy | 1.418 | 1.469 | +3.6% | 1.548 | 1.397 | -9.7% |
| **合计** | **5.232** | **7.103** | **+35.8%** | **5.274** | **6.901** | **+30.8%** |

### 单次运行内部的抖动

| 案例 | 基线冷启动极差 | 修改后冷启动极差 |
| --- | ---: | ---: |
| single-column-body | 17% | 8% |
| two-column-body | 4% | 4% |
| structured-table-and-model | 24% | 12% |
| image-heavy | 15% | 11% |
| reference-heavy | 4% | 42% |
